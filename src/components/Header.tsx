          ...
          <div className="relative bg-navy text-white flex flex-col">
            ...
            <div className="grid grid-cols-2 border-t border-white/30">
              ...
              <a
                ...
                className="px-6 py-6 text-center hover:bg-white/5 transition-colors duration-300 flex flex-col items-center justify-center"
                onClick={() => trackConversion("click_whatsapp", { source: "header_menu" })}
              >
                <svg className="w-5 h-5 mb-3 text-gold" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
                ...
                <p className="font-heading text-[clamp(1.2rem,2vw,1.8rem)] leading-none">WhatsApp</p>
              </a>
            </div>
          </div>
        </div>
